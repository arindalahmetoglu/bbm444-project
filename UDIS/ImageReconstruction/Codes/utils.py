...
def np_load_input(filename):
    ...
    # Removed hardcoded 1024 limit to allow processing at actual canvas size
    # For beehive dataset, this allows proper 2410x1080 processing
    max_dimension = 3000  # Increased limit for larger canvases
